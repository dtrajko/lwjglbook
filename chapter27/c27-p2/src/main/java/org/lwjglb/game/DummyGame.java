...
public class DummyGame implements IGameLogic {
    ...
    public void init(Window window) throws Exception {
        ...
        Mesh[] terrainMesh = StaticMeshesLoader.load("chapter27/c27-p2/src/main/resources/models/terrain/terrain.obj", "chapter27/c27-p2/src/main/resources/models/terrain");
        GameItem terrain = new GameItem(terrainMesh);
        terrain.setScale(100.0f);

        animItem = AnimMeshesLoader.loadAnimGameItem("chapter27/c27-p2/src/main/resources/models/bob/boblamp.md5mesh", "");
        ...
        SkyBox skyBox = new SkyBox("chapter27/c27-p2/src/main/resources/models/skybox.obj", new Vector4f(0.65f, 0.65f, 0.65f, 1.0f));
